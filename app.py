...
cities = ['Hyderabad', 'Delhi', 'Kolkata', 'Ranchi', 'Bangalore', 'Durban',
       'Mumbai', 'Chennai', 'Chandigarh', 'Bengaluru', 'Centurion',
       'Indore', 'Jaipur', 'Ahmedabad', 'Mohali', 'Johannesburg',
       'Raipur', 'Abu Dhabi', 'Visakhapatnam', 'Dharamsala',
